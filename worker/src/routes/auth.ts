...
import { handleRegister, handleResendSignup, handleResetPassword } from "../services/auth.service";

export async function authRoutes(request: Request, env: Env, pathname: string, method: string): Promise<Response | null> {
